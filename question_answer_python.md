...
2. [Абстракция (ООП)](#абстракция)
3. [Инкапсуляция (ООП)](#инкапсуляция)
4. [Наследование (ООП)](#наследование)
5. [Полиморфизм (ООП)](#полиморфизм)
...
10. [ABC (Abstract Base Classes)](#abc)
